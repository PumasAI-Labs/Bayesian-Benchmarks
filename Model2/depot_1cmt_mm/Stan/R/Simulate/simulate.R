...
model_simulate <- 
  cmdstan_model(
    "Model2/depot_1cmt_mm/Stan/Torsten/Simulate/depot_1cmt_lin_plus_mm_ppa.stan") 
...
params_ind <- simulated_data$draws(c("CL", "VC", "VMAX", "KM", "KA")) %>% 
  spread_draws(CL[i], VC[i], VMAX[i], KM[i], KA[i]) %>% 
...
data %>% 
  write_csv(file.path("Model2", "depot_1cmt_mm", "Data", "single_dose.csv"),
            na = ".")

params_ind %>% 
  write_csv("Model2/depot_1cmt_mm/Data/single_dose_params_ind.csv")
...
data %>% 
  write_csv(file.path("Model2", "depot_1cmt_mm", "Data", "multiple_dose.csv"),
            na = ".")

params_ind %>% 
  write_csv("Model2/depot_1cmt_mm/Data/multiple_dose_params_ind.csv")
