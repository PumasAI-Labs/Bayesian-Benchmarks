...
# nonmem_data <- read_csv("Model2/depot_1cmt_mm/Data/multiple_dose.csv",
                        na = ".") %>% 
  rename_all(tolower) %>% 
  rename(ID = "id",
         DV = "dv") %>% 
...
#
# model <- cmdstan_model(
#   "Model2/iv_1cmt_mm/Stan/Torsten/Fit/depot_1cmt_lin_plus_mm_prop.stan",
#   cpp_options = list(stan_threads = TRUE))

model <- cmdstan_model(
  "Model2/depot_1cmt_mm/Stan/Torsten/Fit/depot_1cmt_mm_prop.stan",
  cpp_options = list(stan_threads = TRUE))
...
fit$save_object("Model2/depot_1cmt_mm/Stan/Torsten/Fits/single_dose.rds")
# fit$save_object("Model2/depot_1cmt_mm/Stan/Torsten/Fits/multiple_dose.rds")
