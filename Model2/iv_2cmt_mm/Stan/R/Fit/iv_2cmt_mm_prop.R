...
#
# model <- cmdstan_model(
#   "Model2/iv_2cmt_mm/Stan/Torsten/Fit/iv_2cmt_lin_plus_mm_prop.stan",
#   cpp_options = list(stan_threads = TRUE))

model <- cmdstan_model(
  "Model2/iv_2cmt_mm/Stan/Torsten/Fit/iv_2cmt_mm_prop.stan",
  cpp_options = list(stan_threads = TRUE))
...
fit$save_object("Model2/iv_2cmt_linear/Stan/Torsten/Fits/single_dose.rds")
# fit$save_object("Model2/iv_1cmt_linear/Stan/Torsten/Fits/multiple_dose.rds")
