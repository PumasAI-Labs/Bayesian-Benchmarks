...
model_simulate <- 
  cmdstan_model(
    "Model2/iv_2cmt_linear/Stan/Torsten/Simulate/iv_2cmt_ppa.stan") 
...
data %>% 
  write_csv(file.path("Model2", "iv_2cmt_linear", "Data", "single_dose.csv"),
            na = ".")

params_ind %>% 
  write_csv("Model2/iv_2cmt_linear/Data/single_dose_params_ind.csv")
...
data %>% 
  write_csv(file.path("Model2", "iv_2cmt_linear", "Data", "multiple_dose.csv"),
            na = ".")

params_ind %>% 
  write_csv("Model2/iv_2cmt_linear/Data/multiple_dose_params_ind.csv")
