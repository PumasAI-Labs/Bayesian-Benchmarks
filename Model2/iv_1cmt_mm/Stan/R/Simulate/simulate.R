...
data %>% 
  write_csv(file.path("Model2", "iv_1cmt_mm", "Data", "single_dose.csv"),
            na = ".")

params_ind %>% 
  write_csv("Model2/iv_1cmt_mm/Data/single_dose_params_ind.csv")
...
data %>% 
  write_csv(file.path("Model2", "iv_1cmt_mm", "Data", "multiple_dose.csv"),
            na = ".")

params_ind %>% 
  write_csv("Model2/iv_1cmt_mm/Data/multiple_dose_params_ind.csv")
