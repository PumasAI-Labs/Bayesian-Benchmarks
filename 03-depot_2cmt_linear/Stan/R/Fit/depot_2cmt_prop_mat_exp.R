...
model <- cmdstan_model(
  "03-depot_2cmt_linear/Stan/Torsten/Fit/depot_2cmt_prop_mat_exp.stan",
...
fit$save_object("03-depot_2cmt_linear/Stan/Torsten/Fits/single_dose_mat_exp.rds")
# fit$save_object("03-depot_2cmt_linear/Stan/Torsten/Fits/multiple_dose_mat_exp.rds")
...
fit$draws(parameters_to_summarize, format = "draws_df") %>% 
  as_tibble() %>% 
  write_csv("03-depot_2cmt_linear/Stan/Torsten/Fits/single_dose_draws_df_mat_exp.csv")
# write_csv("03-depot_2cmt_linear/Stan/Torsten/Fits/multiple_dose_draws_df_mat_exp.csv")