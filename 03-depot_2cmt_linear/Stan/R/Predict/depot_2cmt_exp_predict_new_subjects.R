...
fit <- read_rds("03-depot_2cmt_linear/Stan/Torsten/Fits/single_dose_1.rds")
# fit <- read_rds("03-depot_2cmt_linear/Stan/Torsten/Fits/multiple_dose_1.rds")
...
model <- cmdstan_model(
  "03-depot_2cmt_linear/Stan/Torsten/Predict/depot_2cmt_exp_predict_new_subjects.stan"
)
