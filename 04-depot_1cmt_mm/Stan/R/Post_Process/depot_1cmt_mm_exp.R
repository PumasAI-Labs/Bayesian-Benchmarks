...
## Read in fit
# fit <- read_rds("04-depot_1cmt_mm/Stan/Torsten/Fits/single_dose_5.rds")
fit <- read_rds("04-depot_1cmt_mm/Stan/Torsten/Fits/multiple_dose_5.rds")
...
mcmc_combo(fit$draws(c("omega[1]", "omega[2]", "omega[3]", "omega[4]")),
           combo = c("dens_overlay", "trace"))
