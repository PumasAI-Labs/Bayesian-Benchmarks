...
fit <- read_rds("04-depot_1cmt_mm/Stan/Torsten/Fits/single_dose.rds")
# fit <- read_rds("04-depot_1cmt_mm/Stan/Torsten/Fits/multiple_dose.rds")
...
model <- cmdstan_model(
  "04-depot_1cmt_mm/Stan/Torsten/Predict/depot_1cmt_mm_prop_predict_new_subjects.stan")
