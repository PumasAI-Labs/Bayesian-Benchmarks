...
data %>% 
  write_csv(file.path("depot_2cmt_linear", "data", "single_dose.csv"),
            na = ".")

params_ind %>% 
  write_csv("depot_2cmt_linear/data/single_dose_params_ind.csv")
...
data %>% 
  write_csv(file.path("depot_2cmt_linear", "data", "multiple_dose.csv"),
            na = ".")
