...
fit <- read_rds("01-iv_2cmt_linear/Stan/Torsten/Fits/single_dose_1.rds")
# fit <- read_rds("01-iv_2cmt_linear/Stan/Torsten/Fits/multiple_dose_1.rds")
...
model <- cmdstan_model(
  "01-iv_2cmt_linear/Stan/Torsten/Predict/iv_2cmt_exp_predict_observed_subjects.stan")
