...
nonmem_data <- read_csv("depot_2cmt_mm/data/single_dose.csv",
  # nonmem_data <- read_csv("depot_2cmt_mm/data/multiple_dose.csv",
  na = "."
) %>%
  rename_all(tolower) %>%
  rename(
...
#
# model <- cmdstan_model(
#   "depot_2cmt_mm/Stan/Torsten/Fit/depot_2cmt_lin_plus_mm_prop.stan",
#   cpp_options = list(stan_threads = TRUE))

model <- cmdstan_model(
  "depot_2cmt_mm/Stan/Torsten/Fit/depot_2cmt_mm_prop.stan",
  cpp_options = list(stan_threads = TRUE)
)
...
fit$save_object("depot_2cmt_mm/Stan/Torsten/Fits/single_dose.rds")
# fit$save_object("depot_2cmt_mm/Stan/Torsten/Fits/multiple_dose.rds")
