...
$SIGMAP 0.25 FIX 0.25 FIX
$SIGMAPD 1 1 FIX


$EST METHOD=NUTS INTERACTION AUTO=1 PRINT=10 NBURN=200 NITER=400
MASSRESET=0 KAPPA=1.0 MADAPT=250 OLKJDF=2 SEED=12345 FILE=ITERFILE

$COV UNCONDITIONAL MATRIX=R PRINT=E

$TABLE ID EVID TIME IPRED NOPRINT ONEHEADER FORMAT=,1PE13.6 FILE=SDFILE
$TABLE ID CL V1 Q V2 KA MTT CIRC0 GAMMA ALPHA ETAS(1:LAST) NOPRINT NOAPPEND ONEHEADER FORMAT=,1PE13.6 FILE=PAFILE
